   <!-- Cousre Section-->
          <section class="jumbotron bg-white course">
                <div class="container-fluid">
                 ...
                 <!--First Course -->
                    <div class="col-lg-4">
                          <a href="course_detail2?code=CSE111">
                            <div id="ZoomEffect">
                      ...
                      <!--Second Course -->
                       <div class="col-lg-4">
                          <a href="course_detail2?code=CSE112">
                            <div id="ZoomEffect">
                            <img src="images/c.png" id="img">
                          </div>
                          </a>
                         ...
                         <!--Third Course -->
                            <div class="col-lg-4" >
                           <a href="course_detail2?code=CSE113">
                             <div id="ZoomEffect">
                    ...
                    <div class="col-lg-4">
                          <a href="course_detail2?code=CSE114">
                            <div id="ZoomEffect">
                      ...
                      <!--Fifth Course -->
                       <div class="col-lg-4">
                          <a href="course_detail2?code=CSE115">
                            <div id="ZoomEffect">
                          ...
                          <!--sixth Course -->
                           <div class="col-lg-4">
                          <a href="course_detail2?code=CSE116">
                            <div id="ZoomEffect">
...
<div class="jumbotron jumbotron-fluid banner2 ">
  <h1 class="text-center">Follow Versatile</h1>
  <p class="text-center">Follow us on social media for special offers</p>
  <div class="container">
    <div class="row">
      <div class="col text-center">
        <a href="" class="text-white"><i class="fa fa-facebook fa-4x"></i></a>
        <a href="" class="text-white"><i class="fa fa-pinterest fa-4x"></i></a>
        <a href="" class="text-white"><i class="fa fa-twitter fa-4x"></i></a>
        <a href="" class="text-white"><i class="fa fa-linkedin fa-4x"></i></a>
        <a href="" class="text-white"><i class="fa fa-google-plus fa-4x"></i></a>
      </div>
    </div>
  </div>
</div>